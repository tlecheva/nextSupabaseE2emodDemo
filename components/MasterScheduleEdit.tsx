        ...
        <div className='control-pane ml-5'>
            <div className='control-section'>
                < GanttComponent id='Editing' dataSource={editingData} dateFormat={'MMM dd, y'}
                    ...
                    taskFields={taskFields} timelineSettings={timelineSettings} labelSettings={labelSettings}
                    //splitterSettings={splitterSettings}
                    // height={totalHeight + 'px'}
                    editSettings={editSettings} gridLines={gridLines} toolbar={toolbar} resourceFields={resourceFields} resources={editingResources} >
                    <ColumnsDirective>
